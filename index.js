...
const svgContent = (answers) =>{
    ...
    switch(answers.shape){
        case "circle":  svgContent = shapes.renderCircle(answers);
        break;
        case "square":  svgContent = shapes.renderSquare(answers);
        break;
        case "triangle":svgContent = shapes.renderTriangle(answers);
        break;
