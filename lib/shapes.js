class shapes {
    constructor(text, textColor, shapeColor) {
      if (text.length > 3){
        console.log("'text' must contain maximum 3 characters.");
      }
      if (!(this.isValidColor(textColor))){
        console.log("'textColor' is not a valid color string, please enter a string or an hexadecimal value (e.g. #0b0013) ");
      }
